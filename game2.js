...
const steps = [
    { id: 'item-tudung', nextId: 'item-beret', labelHtml: 'PERTAMA SEKALI, <span style="color: #ffb5c5;">TUDUNG HIJAU</span>', img: 'bajuGame1/baseModelPTudung.png' },
    { id: 'item-beret', nextId: 'item-tshirt', labelHtml: 'KEMUDIAN, <span style="color: #ffb5c5;">BERET</span>', img: 'bajuGame1/baseModelPBeret.png' },
    { id: 'item-tshirt', nextId: 'item-pants', labelHtml: 'SETERUSNYA, PAKAI <span style="color: #ffb5c5;">T-SHIRT</span>', img: 'bajuGame1/modelBasePBaju.png' },
    { id: 'item-pants', nextId: 'item-belt', labelHtml: 'SELEPAS ITU, PAKAI <span style="color: #ffb5c5;">SELUAR UNIFORM</span>', img: 'bajuGame1/baseModelPSeluar.png' },
    { id: 'item-belt', nextId: 'item-boots', labelHtml: 'KEMUDIAN, IKAT <span style="color: #ffb5c5;">TALI PINGGANG</span>', img: 'bajuGame1/baseModelPSeluar.png' },
    { id: 'item-boots', nextId: null, labelHtml: 'AKHIR SEKALI, SARUNG <span style="color: #ffb5c5;">KASUT BUT</span>', img: 'bajuGame1/baseModelPBoots.png' }
];
